...
def resnext18(num_classes):
    """Constructs a ResNeXt-18 model.
    """
    model = ResNeXt(BasicBlock, [2, 2, 2, 2], num_classes=num_classes)
    return model


def resnext34(num_classes):
    """Constructs a ResNeXt-34 model.
    """
    model = ResNeXt(BasicBlock, [3, 4, 6, 3], num_classes=num_classes)
    return model
...
def resnext101(num_classes):
    ...
    """
    model = ResNeXt(Bottleneck, [3, 4, 23, 3], num_classes=num_classes)
    return model
...
def resnext152(num_classes):
    ...
    """
    model = ResNeXt(Bottleneck, [3, 8, 36, 3], num_classes=num_classes)
    return model